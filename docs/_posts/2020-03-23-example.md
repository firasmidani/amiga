...
You looked at these results in your favorite data analysis software (e.g. Microsoft Excel, Python, R, … etc.). You filtered  the large table to only include substrates with normalized AUC higher than 1.2.  Finally, you plotted the normalized AUC and Growth Rates as heatmaps and focused only on those substrates.
