...
```bash
python amiga.py heatmap -i /home/outbreaks/erandomii/summary/Biolog_ERandomii_summary_filtered.txt -o Biolog_ERandomii_summary_norm_auc --verbose -x Strain -y Substrate -v "norm(auc)" -p "mean" --kwargs "cmap:Greys;vmin:1;vmax:2" --title "Normalized Growth Rate" --fontsize 15 --width-height 7 13 --x-rotation 0 --save-filtered-data
```

```bash
python amiga.py heatmap -i /home/outbreaks/erandomii/summary/Biolog_ERandomii_summary_norm_auc_filtered.txt -o norm_gr --verbose -x Strain -y Substrate -v "norm(gr)" -p "mean" --kwargs "cmap:Greys;vmin:1;vmax:2" --title "Normalized Growth Rate" --fontsize 15 --width-height 7 13 --x-rotation 0
```
