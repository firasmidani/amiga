...
```bash
python amiga.py -i /home/outbreaks/erandomii -s "Substrate:L-Lactic Acid" -y "H0:Time;H1:Time+Strain" -o "strain_difference_l_lactic_acid" -np 99 -tss 3 --subtract-control
```
...
```bash
python amiga.py -i /home/outbreaks/erandomii -s "Substrate:2-Aminoethanol" -y "H0:Time;H1:Time+Strain" -o "strain_difference_2_aminoethanol" -np 99 -tss 3 --subtract-control
```
