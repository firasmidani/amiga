...
Fitting growth curves takes about 1-3 minutes per 96-well plate. A common warning in terminal is the following

```bash
/home/programs/amiga/libs/agp.py:299: RuntimeWarning:invalid value encountered in sqrt
```

You can disregard this warning. It will not affect the analysis or results. 
