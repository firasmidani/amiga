...
$$
\text{Fold Change}  = \frac{ \displaystyle \max_{t} \text{OD}_{\text{case}}(t)- \text{OD}_{\text{case}}(0)}{ \displaystyle \max_{t} \text{OD}_{\text{control}}(t) - \text{OD}_{\text{control}}(0} \quad \text{where} t\in \{1 \cdots T\}
$$
